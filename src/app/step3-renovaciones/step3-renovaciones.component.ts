...
@Component({
  selector: 'app-step3-renovaciones',
  templateUrl: './step3-renovaciones.component.html',
  styleUrls: ['./step3-renovaciones.component.css'],
  providers: [NgbModalConfig, NgbModal]

})


export class Step3RenovacionesComponent implements OnInit {
